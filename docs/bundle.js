...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {
  displayTopWord()
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.text-submission textarea').on('keydown', breakDownText)
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.text-submission').on('click', breakDownText)
})

const breakDownText = () => {
  if (event.target.nodeName == 'BUTTON' || event.which == 13) {
    let inputValue = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.text-submission textarea').val()
...
const displayWordBreakdown = (wordMap) => {
  for(var index in wordMap) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.word-count').append(`<div class='word' style='font-size:${wordMap[index]}em'>${index}</div>`)
  }
}
...
const renderTopWord = (topWord) => {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.top-word').children('h3').append(`${word} (${wordCount})`)
}
